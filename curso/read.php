...
<div class="row" style="margin-bottom: 10px">
	<div class="col-md-9">
	  <div class="input-group">
	    <input type="text" class="form-control" id="inputpesquisa" name="inputpesquisa" placeholder="Pesquise por curso...">
	...
	<div class="col-md-2">
		<button class="btn btn-primary" onclick="location.href='./formcurso.php'";>Novo Curso</button>
	</div>
</div>
<div class="row">
<div class="col-md-12">
...
if ($result && $statement->rowCount() > 0) { ?>
        ...
        <table class="table table-striped table-bordered table-hover" id="cursostable" name="cursostable">
            ...
            <tr>
                <td><button class="btn btn-primary btn-sm" onclick="location.href='./formcurso.php?id=<?php echo $row["ID"]; ?>'";>Alterar Curso</button></td>
